...
HD_PWD='C:/Users/antho/OneDrive/Documents/Vivado Code Scripts/ECE4305L EXP1 Parameter Barrel Shifter/ECE4305L EXP1 Parameter Barrel Shifter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log barrelDriver.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source barrelDriver.tcl
